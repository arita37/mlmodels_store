...
Finished Task with config: {'activation.choice': 0, 'dropout_prob': 0.08501613127808479, 'embedding_size_factor': 0.7611519652943008, 'layers.choice': 3, 'learning_rate': 0.00017152624887495916, 'network_type.choice': 0, 'use_batchnorm.choice': 0, 'weight_decay': 5.874721297904064e-06} and reward: 0.3836
Finished Task with config: b'\x80\x03}q\x00(X\x11\x00\x00\x00activation.choiceq\x01K\x00X\x0c\x00\x00\x00dropout_probq\x02G?\xb5\xc3\x9d\xffx\xc8\xfdX\x15\x00\x00\x00embedding_size_factorq\x03G?\xe8[[]\xc74lX\r\x00\x00\x00layers.choiceq\x04K\x03X\r\x00\x00\x00learning_rateq\x05G?&{wB6\xb0\xcdX\x13\x00\x00\x00network_type.choiceq\x06K\x00X\x14\x00\x00\x00use_batchnorm.choiceq\x07K\x00X\x0c\x00\x00\x00weight_decayq\x08G>\xd8\xa3\xef\x18 \x95\xc5u.' and reward: 0.3836
Finished Task with config: b'\x80\x03}q\x00(X\x11\x00\x00\x00activation.choiceq\x01K\x00X\x0c\x00\x00\x00dropout_probq\x02G?\xb5\xc3\x9d\xffx\xc8\xfdX\x15\x00\x00\x00embedding_size_factorq\x03G?\xe8[[]\xc74lX\r\x00\x00\x00layers.choiceq\x04K\x03X\r\x00\x00\x00learning_rateq\x05G?&{wB6\xb0\xcdX\x13\x00\x00\x00network_type.choiceq\x06K\x00X\x14\x00\x00\x00use_batchnorm.choiceq\x07K\x00X\x0c\x00\x00\x00weight_decayq\x08G>\xd8\xa3\xef\x18 \x95\xc5u.' and reward: 0.3836
Please either provide filename or allow plot in get_training_curves
Time for Neural Network hyperparameter optimization: 118.6647219657898
Best hyperparameter configuration for Tabular Neural Network: 
{'activation.choice': 0, 'dropout_prob': 0.1, 'embedding_size_factor': 1.0, 'layers.choice': 0, 'learning_rate': 0.0005, 'network_type.choice': 0, 'use_batchnorm.choice': 0, 'weight_decay': 1e-06}
Saving dataset/models/trainer.pkl
Loading: dataset/models/NeuralNetClassifier/trial_0_tabularNN.pkl
Loading: dataset/models/NeuralNetClassifier/trial_1_tabularNN.pkl
Fitting model: weighted_ensemble_k0_l1 ... Training model for up to 119.72s of the -0.67s of remaining time.
Ensemble size: 18
Ensemble weights: 
...
Saving dataset/models/trainer.pkl
Saving dataset/models/trainer.pkl
AutoGluon training complete, total runtime = 121.65s ...
