...
Finished Task with config: {'activation.choice': 2, 'dropout_prob': 0.11199093426125231, 'embedding_size_factor': 0.9327359507769227, 'layers.choice': 1, 'learning_rate': 0.00787573706670706, 'network_type.choice': 1, 'use_batchnorm.choice': 0, 'weight_decay': 0.01592870674501716} and reward: 0.3592
Finished Task with config: b"\x80\x03}q\x00(X\x11\x00\x00\x00activation.choiceq\x01K\x02X\x0c\x00\x00\x00dropout_probq\x02G?\xbc\xabp\x18\x19\xbe\x9aX\x15\x00\x00\x00embedding_size_factorq\x03G?\xed\xd8\xf9\x10\x8c}\xbdX\r\x00\x00\x00layers.choiceq\x04K\x01X\r\x00\x00\x00learning_rateq\x05G?\x80!'\x89\x114\xf6X\x13\x00\x00\x00network_type.choiceq\x06K\x01X\x14\x00\x00\x00use_batchnorm.choiceq\x07K\x00X\x0c\x00\x00\x00weight_decayq\x08G?\x90O\x9dj&RLu." and reward: 0.3592
Finished Task with config: b"\x80\x03}q\x00(X\x11\x00\x00\x00activation.choiceq\x01K\x02X\x0c\x00\x00\x00dropout_probq\x02G?\xbc\xabp\x18\x19\xbe\x9aX\x15\x00\x00\x00embedding_size_factorq\x03G?\xed\xd8\xf9\x10\x8c}\xbdX\r\x00\x00\x00layers.choiceq\x04K\x01X\r\x00\x00\x00learning_rateq\x05G?\x80!'\x89\x114\xf6X\x13\x00\x00\x00network_type.choiceq\x06K\x01X\x14\x00\x00\x00use_batchnorm.choiceq\x07K\x00X\x0c\x00\x00\x00weight_decayq\x08G?\x90O\x9dj&RLu." and reward: 0.3592
Please either provide filename or allow plot in get_training_curves
Time for Neural Network hyperparameter optimization: 152.6146776676178
Best hyperparameter configuration for Tabular Neural Network: 
{'activation.choice': 0, 'dropout_prob': 0.1, 'embedding_size_factor': 1.0, 'layers.choice': 0, 'learning_rate': 0.0005, 'network_type.choice': 0, 'use_batchnorm.choice': 0, 'weight_decay': 1e-06}
Saving dataset/models/trainer.pkl
Loading: dataset/models/NeuralNetClassifier/trial_0_tabularNN.pkl
Loading: dataset/models/NeuralNetClassifier/trial_1_tabularNN.pkl
Fitting model: weighted_ensemble_k0_l1 ... Training model for up to 119.74s of the -34.53s of remaining time.
Ensemble size: 75
Ensemble weights: 
...
Saving dataset/models/trainer.pkl
Saving dataset/models/trainer.pkl
AutoGluon training complete, total runtime = 155.47s ...
