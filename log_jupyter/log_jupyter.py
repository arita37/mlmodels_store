 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/705fb7b9991e363f788a03e67a73e3097087f46c', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/dev/', 'repo': 'arita37/mlmodels', 'branch': 'dev', 'sha': '705fb7b9991e363f788a03e67a73e3097087f46c', 'workflow': 'test_jupyter'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_jupyter

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/dev/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/705fb7b9991e363f788a03e67a73e3097087f46c

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/705fb7b9991e363f788a03e67a73e3097087f46c

 ******** Click here for Online DEBUGGER : https://gitpod.io/#https://github.com/arita37/mlmodels/tree/705fb7b9991e363f788a03e67a73e3097087f46c
...
[0;32m~/work/mlmodels/mlmodels/mlmodels/example/sklearn_titanic_svm.py[0m in [0;36m<module>[0;34m[0m
[1;32m     18[0m [0;34m[0m[0m
[1;32m     19[0m [0mmodel_uri[0m    [0;34m=[0m [0;34m"model_sklearn.sklearn.py"[0m[0;34m[0m[0;34m[0m[0m
[0;32m---> 20[0;31m [0mmodule[0m        [0;34m=[0m  [0mmodule_load[0m[0;34m([0m [0mmodel_uri[0m[0;34m=[0m [0mmodel_uri[0m [0;34m)[0m                           [0;31m# Load file definition[0m[0;34m[0m[0;34m[0m[0m
[0m[1;32m     21[0m [0;34m[0m[0m
[1;32m     22[0m model_pars, data_pars, compute_pars, out_pars = module.get_params(param_pars={
...
[0;32m/opt/hostedtoolcache/Python/3.6.10/x64/lib/python3.6/importlib/_bootstrap.py[0m in [0;36m_load_unlocked[0;34m(spec)[0m

[0;32m/opt/hostedtoolcache/Python/3.6.10/x64/lib/python3.6/importlib/_bootstrap_external.py[0m in [0;36mexec_module[0;34m(self, module)[0m

[0;32m/opt/hostedtoolcache/Python/3.6.10/x64/lib/python3.6/importlib/_bootstrap.py[0m in [0;36m_call_with_frames_removed[0;34m(f, *args, **kwds)[0m

[0;32m~/work/mlmodels/mlmodels/mlmodels/model_sklearn/model_lightgbm.py[0m in [0;36m<module>[0;34m[0m
[1;32m     67[0m [0;32mimport[0m [0mpandas[0m [0;32mas[0m [0mpd[0m[0;34m[0m[0;34m[0m[0m
[0;32m---> 68[0;31m [0;32mfrom[0m [0mlightgbm[0m [0;32mimport[0m [0mLGBMModel[0m[0;34m[0m[0;34m[0m[0m
[0m[1;32m     69[0m [0;34m[0m[0m

[0;32m~/work/mlmodels/mlmodels/mlmodels/example/lightgbm.py[0m in [0;36m<module>[0;34m[0m
[1;32m     26[0m [0;34m[0m[0m
[0;32m---> 27[0;31m [0mpars[0m [0;34m=[0m [0mjson[0m[0;34m.[0m[0mload[0m[0;34m([0m[0mopen[0m[0;34m([0m [0mdata_path[0m [0;34m,[0m [0mmode[0m[0;34m=[0m[0;34m'r'[0m[0;34m)[0m[0;34m)[0m[0;34m[0m[0;34m[0m[0m
...
[1;32m     22[0m [0mmodel_uri[0m    [0;34m=[0m [0;34m"model_sklearn.model_lightgbm.py"[0m[0;34m[0m[0;34m[0m[0m
[0;32m---> 23[0;31m [0mmodule[0m        [0;34m=[0m  [0mmodule_load[0m[0;34m([0m [0mmodel_uri[0m[0;34m=[0m [0mmodel_uri[0m[0;34m)[0m[0;34m[0m[0;34m[0m[0m
[0m[1;32m     24[0m [0;34m[0m[0m
[1;32m     25[0m [0mdata_path[0m [0;34m=[0m [0;34m'lightgbm_titanic.json'[0m[0;34m[0m[0;34m[0m[0m
...
[0;31mNameError[0m: Module model_sklearn.model_lightgbm notfound, [Errno 2] No such file or directory: 'lightgbm_titanic.json', tuple index out of range
...
[0;31mNameError[0m                                 Traceback (most recent call last)
[0;32m~/work/mlmodels/mlmodels/mlmodels/example/sklearn_titanic_randomForest.py[0m in [0;36m<module>[0;34m[0m
[1;32m     19[0m [0;34m[0m[0m
[1;32m     20[0m [0mmodel_uri[0m    [0;34m=[0m [0;34m"model_sklearn.sklearn.py"[0m[0;34m[0m[0;34m[0m[0m
[0;32m---> 21[0;31m [0mmodule[0m        [0;34m=[0m  [0mmodule_load[0m[0;34m([0m [0mmodel_uri[0m[0;34m=[0m [0mmodel_uri[0m [0;34m)[0m                           [0;31m# Load file definition[0m[0;34m[0m[0;34m[0m[0m
[0m[1;32m     22[0m [0;34m[0m[0m
[1;32m     23[0m model_pars, data_pars, compute_pars, out_pars = module.get_params(param_pars={
...
Traceback (most recent call last):
  ...
  File "/home/runner/work/mlmodels/mlmodels/mlmodels/ztest.py", line 592, in main
    globals()[arg.do](arg)
  File "/home/runner/work/mlmodels/mlmodels/mlmodels/ztest.py", line 255, in test_jupyter
    os_file_replace(file2, s1="get_ipython", s2="# get_ipython")   #### Jupyter Flag
  File "/home/runner/work/mlmodels/mlmodels/mlmodels/ztest.py", line 261, in os_file_replace
