...
Finished Task with config: {'activation.choice': 0, 'dropout_prob': 0.15497076200983892, 'embedding_size_factor': 0.9272416296591577, 'layers.choice': 1, 'learning_rate': 0.0028619384377759935, 'network_type.choice': 0, 'use_batchnorm.choice': 1, 'weight_decay': 8.200659635482333e-05} and reward: 0.3922
Finished Task with config: b'\x80\x03}q\x00(X\x11\x00\x00\x00activation.choiceq\x01K\x00X\x0c\x00\x00\x00dropout_probq\x02G?\xc3\xd6\x14\xf9U\x90\x03X\x15\x00\x00\x00embedding_size_factorq\x03G?\xed\xab\xf6\xa3\\\x06\xc4X\r\x00\x00\x00layers.choiceq\x04K\x01X\r\x00\x00\x00learning_rateq\x05G?gq\xeb\x7f\xca\n\x87X\x13\x00\x00\x00network_type.choiceq\x06K\x00X\x14\x00\x00\x00use_batchnorm.choiceq\x07K\x01X\x0c\x00\x00\x00weight_decayq\x08G?\x15\x7f^\x98\xfc`Ru.' and reward: 0.3922
Finished Task with config: b'\x80\x03}q\x00(X\x11\x00\x00\x00activation.choiceq\x01K\x00X\x0c\x00\x00\x00dropout_probq\x02G?\xc3\xd6\x14\xf9U\x90\x03X\x15\x00\x00\x00embedding_size_factorq\x03G?\xed\xab\xf6\xa3\\\x06\xc4X\r\x00\x00\x00layers.choiceq\x04K\x01X\r\x00\x00\x00learning_rateq\x05G?gq\xeb\x7f\xca\n\x87X\x13\x00\x00\x00network_type.choiceq\x06K\x00X\x14\x00\x00\x00use_batchnorm.choiceq\x07K\x01X\x0c\x00\x00\x00weight_decayq\x08G?\x15\x7f^\x98\xfc`Ru.' and reward: 0.3922
Please either provide filename or allow plot in get_training_curves
Time for Neural Network hyperparameter optimization: 130.4651255607605
Best hyperparameter configuration for Tabular Neural Network: 
{'activation.choice': 0, 'dropout_prob': 0.15497076200983892, 'embedding_size_factor': 0.9272416296591577, 'layers.choice': 1, 'learning_rate': 0.0028619384377759935, 'network_type.choice': 0, 'use_batchnorm.choice': 1, 'weight_decay': 8.200659635482333e-05}
Saving dataset/models/trainer.pkl
Loading: dataset/models/NeuralNetClassifier/trial_0_tabularNN.pkl
Loading: dataset/models/NeuralNetClassifier/trial_1_tabularNN.pkl
Fitting model: weighted_ensemble_k0_l1 ... Training model for up to 119.72s of the -12.49s of remaining time.
Ensemble size: 17
Ensemble weights: 
...
Saving dataset/models/trainer.pkl
Saving dataset/models/trainer.pkl
AutoGluon training complete, total runtime = 133.59s ...
