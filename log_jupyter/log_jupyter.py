...
Finished Task with config: {'activation.choice': 1, 'dropout_prob': 0.38409737934610305, 'embedding_size_factor': 0.856407739281168, 'layers.choice': 1, 'learning_rate': 0.004876762118717018, 'network_type.choice': 0, 'use_batchnorm.choice': 0, 'weight_decay': 1.2407139727598389e-06} and reward: 0.3704
Finished Task with config: b'\x80\x03}q\x00(X\x11\x00\x00\x00activation.choiceq\x01K\x01X\x0c\x00\x00\x00dropout_probq\x02G?\xd8\x95\r,\xb1U\x17X\x15\x00\x00\x00embedding_size_factorq\x03G?\xebg\xb14\x08 \nX\r\x00\x00\x00layers.choiceq\x04K\x01X\r\x00\x00\x00learning_rateq\x05G?s\xf9\xa7\xdc\xf6\xd4\x83X\x13\x00\x00\x00network_type.choiceq\x06K\x00X\x14\x00\x00\x00use_batchnorm.choiceq\x07K\x00X\x0c\x00\x00\x00weight_decayq\x08G>\xb4\xd0\xd3p\x96P1u.' and reward: 0.3704
Finished Task with config: b'\x80\x03}q\x00(X\x11\x00\x00\x00activation.choiceq\x01K\x01X\x0c\x00\x00\x00dropout_probq\x02G?\xd8\x95\r,\xb1U\x17X\x15\x00\x00\x00embedding_size_factorq\x03G?\xebg\xb14\x08 \nX\r\x00\x00\x00layers.choiceq\x04K\x01X\r\x00\x00\x00learning_rateq\x05G?s\xf9\xa7\xdc\xf6\xd4\x83X\x13\x00\x00\x00network_type.choiceq\x06K\x00X\x14\x00\x00\x00use_batchnorm.choiceq\x07K\x00X\x0c\x00\x00\x00weight_decayq\x08G>\xb4\xd0\xd3p\x96P1u.' and reward: 0.3704
Please either provide filename or allow plot in get_training_curves
Time for Neural Network hyperparameter optimization: 197.41263103485107
Best hyperparameter configuration for Tabular Neural Network: 
{'activation.choice': 0, 'dropout_prob': 0.1, 'embedding_size_factor': 1.0, 'layers.choice': 0, 'learning_rate': 0.0005, 'network_type.choice': 0, 'use_batchnorm.choice': 0, 'weight_decay': 1e-06}
Saving dataset/models/trainer.pkl
Loading: dataset/models/NeuralNetClassifier/trial_0_tabularNN.pkl
Loading: dataset/models/NeuralNetClassifier/trial_1_tabularNN.pkl
Fitting model: weighted_ensemble_k0_l1 ... Training model for up to 119.71s of the -79.68s of remaining time.
Ensemble size: 32
Ensemble weights: 
[0.84375 0.15625]
...
Saving dataset/models/trainer.pkl
Saving dataset/models/trainer.pkl
AutoGluon training complete, total runtime = 200.67s ...
