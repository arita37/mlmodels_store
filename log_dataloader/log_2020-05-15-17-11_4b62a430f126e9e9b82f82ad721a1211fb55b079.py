 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/4b62a430f126e9e9b82f82ad721a1211fb55b079', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '4b62a430f126e9e9b82f82ad721a1211fb55b079', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/4b62a430f126e9e9b82f82ad721a1211fb55b079

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/4b62a430f126e9e9b82f82ad721a1211fb55b079
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fb99ccc0ea0>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fb99ccc0ea0>

  function with postional parmater data_info <function get_dataset_torch at 0x7fb99ccc0ea0> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
Using TensorFlow backend.
0it [00:00, ?it/s]  0%|          | 16384/9912422 [00:00<01:13, 134563.86it/s] 70%|██████▉   | 6930432/9912422 [00:00<00:15, 192073.84it/s]9920512it [00:00, 40187604.77it/s]                           
0it [00:00, ?it/s]32768it [00:00, 703588.38it/s]
0it [00:00, ?it/s]  6%|▋         | 106496/1648877 [00:00<00:01, 1023726.86it/s]1654784it [00:00, 12675767.41it/s]                           
0it [00:00, ?it/s]8192it [00:00, 184197.98it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fb985ed0f98>, <torch.utils.data.dataloader.DataLoader object at 0x7fb985ed9b70>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fb985efa0d0>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fb985efa0d0>

  function with postional parmater data_info <function get_dataset_torch at 0x7fb985efa0d0> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fb9854bdd30>, <torch.utils.data.dataloader.DataLoader object at 0x7fb9854bdda0>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fb99ccc5e18>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fb99ccc5e18>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fb9ef443ae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fb9ef443ae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fb986b467b8>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fb986b467b8>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7fb984ded2e8> 
