...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f95576a0378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f95576a0378>

  function with postional parmater data_info <function get_dataset_torch at 0x7f95576a0378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 16384/9912422 [00:00<01:02, 157484.89it/s] 77%|███████▋  | 7593984/9912422 [00:00<00:10, 224777.73it/s]9920512it [00:00, 44227937.04it/s]                           
0it [00:00, ?it/s]32768it [00:00, 631987.50it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 467821.02it/s]1654784it [00:00, 12193251.75it/s]                         
0it [00:00, ?it/s]8192it [00:00, 175149.30it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f95561d20f0>, <torch.utils.data.dataloader.DataLoader object at 0x7f95561ef828>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f95559f2400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f95559f2400>

  function with postional parmater data_info <function get_dataset_torch at 0x7f95559f2400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f9555a00a90>, <torch.utils.data.dataloader.DataLoader object at 0x7f9555a00b00>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f9555a05b70>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f9555a05b70>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f95a9e23e18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f95a9e23e18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f95559f2488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f95559f2488>
