 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/21e83bced0ec711855092ada154fdff94b058d94', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '21e83bced0ec711855092ada154fdff94b058d94', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/21e83bced0ec711855092ada154fdff94b058d94

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/21e83bced0ec711855092ada154fdff94b058d94
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f808c9fed90>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f808c9fed90>

  function with postional parmater data_info <function get_dataset_torch at 0x7f808c9fed90> , (data_info, **args) 

  #### If transformer URI is Provided 
transform torchvision_dataset_MNIST_load() missing 1 required positional argument: 'path'

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 16%|█▌        | 1564672/9912422 [00:00<00:00, 15638122.27it/s]9920512it [00:00, 31610199.19it/s]                             
0it [00:00, ?it/s]32768it [00:00, 595977.44it/s]
0it [00:00, ?it/s]  2%|▏         | 40960/1648877 [00:00<00:03, 408262.97it/s]1654784it [00:00, 11756927.96it/s]                         
0it [00:00, ?it/s]8192it [00:00, 143953.12it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f808ca0e320>, <torch.utils.data.dataloader.DataLoader object at 0x7f808ad40978>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f808b54ce18>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f808b54ce18>

  function with postional parmater data_info <function get_dataset_torch at 0x7f808b54ce18> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f808ad5c978>, <torch.utils.data.dataloader.DataLoader object at 0x7f808ad5c9e8>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f808b52f7b8>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f808b52f7b8>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f80df184a60>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f80df184a60>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f808ad5e0d0>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f808ad5e0d0>
