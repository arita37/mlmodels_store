 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/c7f60da4b2d69cec32e6753f33fd0c5dcf6078fc', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': 'c7f60da4b2d69cec32e6753f33fd0c5dcf6078fc', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/c7f60da4b2d69cec32e6753f33fd0c5dcf6078fc

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/c7f60da4b2d69cec32e6753f33fd0c5dcf6078fc
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fb69ba22048>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fb69ba22048>

  function with postional parmater data_info <function get_dataset_torch at 0x7fb69ba22048> , (data_info, **args) 
...
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 27%|██▋       | 2629632/9912422 [00:00<00:00, 26252094.00it/s]9920512it [00:00, 30767715.56it/s]                             
0it [00:00, ?it/s]32768it [00:00, 695270.33it/s]
0it [00:00, ?it/s]  1%|          | 16384/1648877 [00:00<00:11, 147342.74it/s]1654784it [00:00, 10471910.59it/s]                         
0it [00:00, ?it/s]8192it [00:00, 213777.02it/s]Downloading http://yann.lecun.com/exdb/mnist/train-images-idx3-ubyte.gz to mlmodels/dataset/vision/MNIST/MNIST/raw/train-images-idx3-ubyte.gz
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fb68503be80>, <torch.utils.data.dataloader.DataLoader object at 0x7fb684c3dcf8>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fb684c34f28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fb684c34f28>

  function with postional parmater data_info <function get_dataset_torch at 0x7fb684c34f28> , (data_info, **args) 
...
transform torchvision_dataset_MNIST_load() missing 1 required positional argument: 'path'
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fb6842206d8>, <torch.utils.data.dataloader.DataLoader object at 0x7fb684220748>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fb69ab6f268>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fb69ab6f268>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fb6ee1a1ae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fb6ee1a1ae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fb69ab6fa60>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fb69ab6fa60>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7fb6842200f0> 
