 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/c32cd0987286bc82dd3082ea685337a56f3e6278', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': 'c32cd0987286bc82dd3082ea685337a56f3e6278', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/c32cd0987286bc82dd3082ea685337a56f3e6278

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/c32cd0987286bc82dd3082ea685337a56f3e6278
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f887976fd90>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f887976fd90>

  function with postional parmater data_info <function get_dataset_torch at 0x7f887976fd90> , (data_info, **args) 

  #### If transformer URI is Provided 
transform torchvision_dataset_MNIST_load() missing 1 required positional argument: 'path'

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 16384/9912422 [00:00<01:13, 134874.19it/s] 72%|███████▏  | 7143424/9912422 [00:00<00:14, 192520.60it/s]9920512it [00:00, 40170999.17it/s]                           
0it [00:00, ?it/s]32768it [00:00, 584610.28it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 477691.86it/s]1654784it [00:00, 11845657.98it/s]                         
0it [00:00, ?it/s]8192it [00:00, 175649.81it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f887977d2b0>, <torch.utils.data.dataloader.DataLoader object at 0x7f8877aaf8d0>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f88782bbe18>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f88782bbe18>

  function with postional parmater data_info <function get_dataset_torch at 0x7f88782bbe18> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f8877acc908>, <torch.utils.data.dataloader.DataLoader object at 0x7f8877acc978>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f88782a07b8>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f88782a07b8>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f88cbef3a60>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f88cbef3a60>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f8877ace0d0>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f8877ace0d0>
