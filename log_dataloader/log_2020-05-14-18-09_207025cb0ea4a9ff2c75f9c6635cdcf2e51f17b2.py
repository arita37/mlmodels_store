...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7faf0f10d378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7faf0f10d378>

  function with postional parmater data_info <function get_dataset_torch at 0x7faf0f10d378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s]  2%|▏         | 204800/9912422 [00:00<00:04, 2043446.67it/s]9920512it [00:00, 30907835.89it/s]                           
0it [00:00, ?it/s]  0%|          | 0/28881 [00:00<?, ?it/s]32768it [00:00, 262105.51it/s]           
0it [00:00, ?it/s]  1%|          | 16384/1648877 [00:00<00:10, 162454.32it/s]1654784it [00:00, 10944696.98it/s]                         
0it [00:00, ?it/s]8192it [00:00, 150434.05it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7faf0dc410b8>, <torch.utils.data.dataloader.DataLoader object at 0x7faf0d44a7f0>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7faf0d460400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7faf0d460400>

  function with postional parmater data_info <function get_dataset_torch at 0x7faf0d460400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7faf0d46da58>, <torch.utils.data.dataloader.DataLoader object at 0x7faf0d46dac8>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7faf0d472b70>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7faf0d472b70>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7faf61891e18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7faf61891e18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7faf0d460488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7faf0d460488>
