 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/303e772567b9b5a2df33ee5d2a93d121c9077c8d', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '303e772567b9b5a2df33ee5d2a93d121c9077c8d', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/303e772567b9b5a2df33ee5d2a93d121c9077c8d

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/303e772567b9b5a2df33ee5d2a93d121c9077c8d
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f878d6e4f28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f878d6e4f28>

  function with postional parmater data_info <function get_dataset_torch at 0x7f878d6e4f28> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s]  9%|▉         | 901120/9912422 [00:00<00:01, 8973745.78it/s] 30%|██▉       | 2973696/9912422 [00:00<00:00, 10795215.71it/s] 70%|██████▉   | 6905856/9912422 [00:00<00:00, 13737132.21it/s]9920512it [00:00, 20044310.38it/s]                             
0it [00:00, ?it/s]32768it [00:00, 597620.43it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 487452.84it/s]1654784it [00:00, 12133121.37it/s]                         
0it [00:00, ?it/s]8192it [00:00, 202089.96it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f878c218128>, <torch.utils.data.dataloader.DataLoader object at 0x7f878c233940>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f878c22ef28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f878c22ef28>

  function with postional parmater data_info <function get_dataset_torch at 0x7f878c22ef28> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f878ba44ac8>, <torch.utils.data.dataloader.DataLoader object at 0x7f878ba44b38>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f87702b41e0>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f87702b41e0>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f87dfe68ae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f87dfe68ae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f878ba3c400>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f878ba3c400>
