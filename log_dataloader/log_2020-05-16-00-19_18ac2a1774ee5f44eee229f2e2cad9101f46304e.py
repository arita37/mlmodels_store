 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/18ac2a1774ee5f44eee229f2e2cad9101f46304e', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '18ac2a1774ee5f44eee229f2e2cad9101f46304e', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/18ac2a1774ee5f44eee229f2e2cad9101f46304e

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/18ac2a1774ee5f44eee229f2e2cad9101f46304e
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f0079096048>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f0079096048>

  function with postional parmater data_info <function get_dataset_torch at 0x7f0079096048> , (data_info, **args) 
...
0it [00:00, ?it/s]  0%|          | 16384/9912422 [00:00<01:05, 151693.94it/s] 62%|██████▏   | 6152192/9912422 [00:00<00:17, 216468.49it/s]9920512it [00:00, 38482479.88it/s]                           
0it [00:00, ?it/s]32768it [00:00, 542814.30it/s]
0it [00:00, ?it/s]  1%|          | 16384/1648877 [00:00<00:10, 157647.11it/s]1654784it [00:00, 11020570.52it/s]                         
0it [00:00, ?it/s]8192it [00:00, 185796.61it/s]Downloading http://yann.lecun.com/exdb/mnist/train-images-idx3-ubyte.gz to mlmodels/dataset/vision/MNIST/MNIST/raw/train-images-idx3-ubyte.gz
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f00626afe80>, <torch.utils.data.dataloader.DataLoader object at 0x7f00622b2d30>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f00622a7f28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f00622a7f28>

  function with postional parmater data_info <function get_dataset_torch at 0x7f00622a7f28> , (data_info, **args) 
...
transform torchvision_dataset_MNIST_load() missing 1 required positional argument: 'path'
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f00618946d8>, <torch.utils.data.dataloader.DataLoader object at 0x7f0061894748>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f00781e32f0>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f00781e32f0>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f00cb815ae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f00cb815ae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f00781e39d8>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f00781e39d8>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7f00618940f0> 
