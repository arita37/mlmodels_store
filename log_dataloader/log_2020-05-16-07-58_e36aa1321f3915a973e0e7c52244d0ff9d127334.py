 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/e36aa1321f3915a973e0e7c52244d0ff9d127334', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': 'e36aa1321f3915a973e0e7c52244d0ff9d127334', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/e36aa1321f3915a973e0e7c52244d0ff9d127334

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/e36aa1321f3915a973e0e7c52244d0ff9d127334
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f5256d78048>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f5256d78048>

  function with postional parmater data_info <function get_dataset_torch at 0x7f5256d78048> , (data_info, **args) 
...
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 33%|███▎      | 3276800/9912422 [00:00<00:00, 32762485.30it/s]9920512it [00:00, 34698528.96it/s]                             
0it [00:00, ?it/s]32768it [00:00, 599889.80it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 462742.88it/s]1654784it [00:00, 11839858.53it/s]                         
0it [00:00, ?it/s]8192it [00:00, 166396.63it/s]Downloading http://yann.lecun.com/exdb/mnist/train-images-idx3-ubyte.gz to mlmodels/dataset/vision/MNIST/MNIST/raw/train-images-idx3-ubyte.gz
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f523ff879b0>, <torch.utils.data.dataloader.DataLoader object at 0x7f523ff94d68>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f523ff89f28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f523ff89f28>

  function with postional parmater data_info <function get_dataset_torch at 0x7f523ff89f28> , (data_info, **args) 
...
transform torchvision_dataset_MNIST_load() missing 1 required positional argument: 'path'
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f523c8996d8>, <torch.utils.data.dataloader.DataLoader object at 0x7f523c899748>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f5255ec5268>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f5255ec5268>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f52a94f7ae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f52a94f7ae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f5255ec5a60>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f5255ec5a60>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7f523c899320> 
