...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7faab8cdd378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7faab8cdd378>

  function with postional parmater data_info <function get_dataset_torch at 0x7faab8cdd378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 35%|███▌      | 3497984/9912422 [00:00<00:00, 34732029.94it/s]9920512it [00:00, 35522688.41it/s]                             
0it [00:00, ?it/s]32768it [00:00, 615923.21it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 471199.88it/s]1654784it [00:00, 11905089.45it/s]                         
0it [00:00, ?it/s]8192it [00:00, 188405.71it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7faab7812048>, <torch.utils.data.dataloader.DataLoader object at 0x7faab701d748>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7faab7031400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7faab7031400>

  function with postional parmater data_info <function get_dataset_torch at 0x7faab7031400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7faab703c9e8>, <torch.utils.data.dataloader.DataLoader object at 0x7faab703ca58>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7faab7042b70>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7faab7042b70>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fab0b461e18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fab0b461e18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7faab7031488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7faab7031488>
