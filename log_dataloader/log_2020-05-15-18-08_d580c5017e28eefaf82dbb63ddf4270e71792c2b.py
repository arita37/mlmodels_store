...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f4e79bde378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f4e79bde378>

  function with postional parmater data_info <function get_dataset_torch at 0x7f4e79bde378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 49152/9912422 [00:00<00:20, 474476.07it/s] 92%|█████████▏| 9109504/9912422 [00:00<00:01, 676297.28it/s]9920512it [00:00, 47200119.75it/s]                           
0it [00:00, ?it/s]32768it [00:00, 742275.31it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 475441.19it/s]1654784it [00:00, 11845637.76it/s]                         
0it [00:00, ?it/s]8192it [00:00, 222250.72it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f4e78b59fd0>, <torch.utils.data.dataloader.DataLoader object at 0x7f4e7811c748>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f4e78132400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f4e78132400>

  function with postional parmater data_info <function get_dataset_torch at 0x7f4e78132400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f4e781429b0>, <torch.utils.data.dataloader.DataLoader object at 0x7f4e78142a20>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f4e78b63d90>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f4e78b63d90>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f4ecc35de18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f4ecc35de18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f4e78144a60>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f4e78144a60>
