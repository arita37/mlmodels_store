 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/59f84634c8d0495da4866056de9812029416019e', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '59f84634c8d0495da4866056de9812029416019e', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/59f84634c8d0495da4866056de9812029416019e

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/59f84634c8d0495da4866056de9812029416019e
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fd8aadc6f28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fd8aadc6f28>

  function with postional parmater data_info <function get_dataset_torch at 0x7fd8aadc6f28> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s]  0%|          | 49152/9912422 [00:00<00:21, 456628.05it/s]  6%|▌         | 606208/9912422 [00:00<00:14, 630015.55it/s] 62%|██████▏   | 6127616/9912422 [00:00<00:04, 895641.92it/s]9920512it [00:00, 17898914.86it/s]                           
0it [00:00, ?it/s]32768it [00:00, 364788.88it/s]
0it [00:00, ?it/s]  0%|          | 0/1648877 [00:00<?, ?it/s]  5%|▍         | 81920/1648877 [00:00<00:01, 815762.14it/s] 35%|███▌      | 581632/1648877 [00:00<00:00, 1088750.71it/s]1654784it [00:00, 4431261.49it/s]                            
0it [00:00, ?it/s]  0%|          | 0/4542 [00:00<?, ?it/s]8192it [00:00, 64799.86it/s]            dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fd8a98fb160>, <torch.utils.data.dataloader.DataLoader object at 0x7fd8a9917978>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fd8a9912f28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fd8a9912f28>

  function with postional parmater data_info <function get_dataset_torch at 0x7fd8a9912f28> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fd8a911eb00>, <torch.utils.data.dataloader.DataLoader object at 0x7fd8a911eb70>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fd88d9b21e0>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fd88d9b21e0>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fd8fd549ae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fd8fd549ae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fd8a911c488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fd8a911c488>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7fd8a8571390> 
