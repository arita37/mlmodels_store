 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/5accff2c28597ab519679b974572739de131262c', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/dev/', 'repo': 'arita37/mlmodels', 'branch': 'dev', 'sha': '5accff2c28597ab519679b974572739de131262c', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/dev/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/5accff2c28597ab519679b974572739de131262c

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/5accff2c28597ab519679b974572739de131262c
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f55aaa55400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f55aaa55400>

  function with postional parmater data_info <function get_dataset_torch at 0x7f55aaa55400> , (data_info, **args) 
...
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 36%|███▌      | 3555328/9912422 [00:00<00:00, 35213129.37it/s]9920512it [00:00, 35007389.53it/s]                             
0it [00:00, ?it/s]32768it [00:00, 625757.86it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 462822.87it/s]1654784it [00:00, 11650262.44it/s]                         
0it [00:00, ?it/s]8192it [00:00, 191459.69it/s]Downloading http://yann.lecun.com/exdb/mnist/train-images-idx3-ubyte.gz to mlmodels/dataset/vision/MNIST/MNIST/raw/train-images-idx3-ubyte.gz
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f5593c6d940>, <torch.utils.data.dataloader.DataLoader object at 0x7f5593c7a978>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f5593c767b8>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f5593c767b8>

  function with postional parmater data_info <function get_dataset_torch at 0x7f5593c767b8> , (data_info, **args) 
...
transform torchvision_dataset_MNIST_load() missing 1 required positional argument: 'path'
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f5593259668>, <torch.utils.data.dataloader.DataLoader object at 0x7f55932596d8>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f55a9ba0268>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f55a9ba0268>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f55fd1d5e18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f55fd1d5e18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f5594866048>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f5594866048>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7f5592c0d208> 
