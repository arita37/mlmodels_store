...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f56ee896378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f56ee896378>

  function with postional parmater data_info <function get_dataset_torch at 0x7f56ee896378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 38%|███▊      | 3727360/9912422 [00:00<00:00, 37263418.60it/s]9920512it [00:00, 34481862.82it/s]                             
0it [00:00, ?it/s]32768it [00:00, 559698.29it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 470651.26it/s]1654784it [00:00, 12000185.26it/s]                         
0it [00:00, ?it/s]8192it [00:00, 203827.06it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f56ed3c80f0>, <torch.utils.data.dataloader.DataLoader object at 0x7f56ecbd37f0>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f56ecbe9400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f56ecbe9400>

  function with postional parmater data_info <function get_dataset_torch at 0x7f56ecbe9400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f56ecbf4a90>, <torch.utils.data.dataloader.DataLoader object at 0x7f56ecbf4b00>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f56ecbfab70>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f56ecbfab70>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f5741019e18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f5741019e18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f56ecbe9488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f56ecbe9488>
