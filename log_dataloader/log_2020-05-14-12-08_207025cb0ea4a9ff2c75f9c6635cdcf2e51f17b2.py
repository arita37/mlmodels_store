...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f5b578c9378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f5b578c9378>

  function with postional parmater data_info <function get_dataset_torch at 0x7f5b578c9378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 16384/9912422 [00:00<01:10, 139692.47it/s] 61%|██████    | 6045696/9912422 [00:00<00:19, 199361.25it/s]9920512it [00:00, 37939006.36it/s]                           
0it [00:00, ?it/s]32768it [00:00, 1219003.20it/s]
0it [00:00, ?it/s]  6%|▋         | 106496/1648877 [00:00<00:01, 988966.48it/s]1654784it [00:00, 12757101.94it/s]                          
0it [00:00, ?it/s]8192it [00:00, 215988.95it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f5b563fe048>, <torch.utils.data.dataloader.DataLoader object at 0x7f5b55c08780>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f5b55c1c400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f5b55c1c400>

  function with postional parmater data_info <function get_dataset_torch at 0x7f5b55c1c400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f5b55c299e8>, <torch.utils.data.dataloader.DataLoader object at 0x7f5b55c29a58>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f5b55c2eb70>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f5b55c2eb70>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f5baa04de18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f5baa04de18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f5b55c1c488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f5b55c1c488>
