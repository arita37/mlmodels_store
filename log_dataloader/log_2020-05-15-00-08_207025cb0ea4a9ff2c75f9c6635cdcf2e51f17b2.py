...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fedbaf46378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fedbaf46378>

  function with postional parmater data_info <function get_dataset_torch at 0x7fedbaf46378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 35%|███▌      | 3481600/9912422 [00:00<00:00, 33472749.88it/s]9920512it [00:00, 34504108.57it/s]                             
0it [00:00, ?it/s]32768it [00:00, 618350.69it/s]
0it [00:00, ?it/s]  6%|▌         | 98304/1648877 [00:00<00:01, 961140.69it/s]1654784it [00:00, 12124029.04it/s]                         
0it [00:00, ?it/s]8192it [00:00, 218709.75it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fedb9a7a0b8>, <torch.utils.data.dataloader.DataLoader object at 0x7fedb92847f0>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fedb9299400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fedb9299400>

  function with postional parmater data_info <function get_dataset_torch at 0x7fedb9299400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fedb92a4a58>, <torch.utils.data.dataloader.DataLoader object at 0x7fedb92a4ac8>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fedb92aab70>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fedb92aab70>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fee0d6c9e18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fee0d6c9e18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fedb9299488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fedb9299488>
