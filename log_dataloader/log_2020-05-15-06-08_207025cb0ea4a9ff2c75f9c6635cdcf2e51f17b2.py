...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f00d7442378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f00d7442378>

  function with postional parmater data_info <function get_dataset_torch at 0x7f00d7442378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 16384/9912422 [00:00<01:16, 128640.70it/s] 36%|███▌      | 3547136/9912422 [00:00<00:34, 183474.45it/s]9920512it [00:00, 32145097.74it/s]                           
0it [00:00, ?it/s]32768it [00:00, 655248.14it/s]
0it [00:00, ?it/s]  6%|▋         | 106496/1648877 [00:00<00:01, 1032310.44it/s]1654784it [00:00, 12738488.10it/s]                           
0it [00:00, ?it/s]8192it [00:00, 202841.56it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f00d5f760b8>, <torch.utils.data.dataloader.DataLoader object at 0x7f00d577e7f0>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f00d5794400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f00d5794400>

  function with postional parmater data_info <function get_dataset_torch at 0x7f00d5794400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f00d57a2a58>, <torch.utils.data.dataloader.DataLoader object at 0x7f00d57a2ac8>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f00d57a7b70>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f00d57a7b70>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f0129bc5e18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f0129bc5e18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f00d5794488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f00d5794488>
