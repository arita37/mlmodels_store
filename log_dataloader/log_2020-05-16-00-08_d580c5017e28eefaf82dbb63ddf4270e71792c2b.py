 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/d580c5017e28eefaf82dbb63ddf4270e71792c2b', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/dev/', 'repo': 'arita37/mlmodels', 'branch': 'dev', 'sha': 'd580c5017e28eefaf82dbb63ddf4270e71792c2b', 'workflow': 'test_dataloader'}
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fea3e206378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fea3e206378>

  function with postional parmater data_info <function get_dataset_torch at 0x7fea3e206378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 49152/9912422 [00:00<00:21, 468796.53it/s] 96%|█████████▌| 9510912/9912422 [00:00<00:00, 668270.28it/s]9920512it [00:00, 47723500.86it/s]                           
0it [00:00, ?it/s]32768it [00:00, 640361.90it/s]
0it [00:00, ?it/s]  4%|▍         | 65536/1648877 [00:00<00:02, 653050.05it/s] 79%|███████▉  | 1302528/1648877 [00:00<00:00, 911579.84it/s]1654784it [00:00, 7509764.62it/s]                            
0it [00:00, ?it/s]8192it [00:00, 209561.71it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fea3d183fd0>, <torch.utils.data.dataloader.DataLoader object at 0x7fea3c5438d0>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fea3c556400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fea3c556400>

  function with postional parmater data_info <function get_dataset_torch at 0x7fea3c556400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fea3c5649b0>, <torch.utils.data.dataloader.DataLoader object at 0x7fea3c564a20>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fea3d18dd90>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fea3d18dd90>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fea90987e18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fea90987e18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fea3c568a60>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fea3c568a60>
