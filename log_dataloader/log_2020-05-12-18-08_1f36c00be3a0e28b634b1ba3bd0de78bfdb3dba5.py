...
['namentity_crm_bilstm_new.json', 'resnet34_benchmark_mnist.json', 'matchzoo_models_new.json', 'kears_textcnn.json', 'keras_reuters_charcnn.json', 'armdn_dataloader.json', 'resnet18_benchmark_mnist.json', 'torchhub_cnn_dataloader.json', 'resnet18_benchmark_new.json']
...
Processing...
Done!
((<torch.utils.data.dataloader.DataLoader object at 0x7fbc25199ac8>, <torch.utils.data.dataloader.DataLoader object at 0x7fbbbf1a2ac8>), {})
