 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/0ad6d85c07617bb79b8698f0f5b9434fbf240370', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '0ad6d85c07617bb79b8698f0f5b9434fbf240370', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/0ad6d85c07617bb79b8698f0f5b9434fbf240370

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/0ad6d85c07617bb79b8698f0f5b9434fbf240370
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fb431f08f28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fb431f08f28>

  function with postional parmater data_info <function get_dataset_torch at 0x7fb431f08f28> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
Using TensorFlow backend.
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 37%|███▋      | 3620864/9912422 [00:00<00:00, 36155660.37it/s]9920512it [00:00, 34860772.01it/s]                             
0it [00:00, ?it/s]32768it [00:00, 536883.50it/s]
0it [00:00, ?it/s]  0%|          | 0/1648877 [00:00<?, ?it/s]1654784it [00:00, 8322512.09it/s]          
0it [00:00, ?it/s]8192it [00:00, 191181.64it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fb41b117fd0>, <torch.utils.data.dataloader.DataLoader object at 0x7fb41b121400>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fb41b141158>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fb41b141158>

  function with postional parmater data_info <function get_dataset_torch at 0x7fb41b141158> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fb41a705d68>, <torch.utils.data.dataloader.DataLoader object at 0x7fb41a705dd8>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fb431f11ea0>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fb431f11ea0>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fb48468cae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fb48468cae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fb41bd8e840>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fb41bd8e840>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7fb431f06eb8> 
