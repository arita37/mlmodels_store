 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/2b96975c118d51fb4af681716a53cf19d9705f8d', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '2b96975c118d51fb4af681716a53cf19d9705f8d', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/2b96975c118d51fb4af681716a53cf19d9705f8d

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/2b96975c118d51fb4af681716a53cf19d9705f8d
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f439c301048>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f439c301048>

  function with postional parmater data_info <function get_dataset_torch at 0x7f439c301048> , (data_info, **args) 
...
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 29%|██▉       | 2891776/9912422 [00:00<00:00, 28840637.17it/s]9920512it [00:00, 31821141.75it/s]                             
0it [00:00, ?it/s]32768it [00:00, 684890.11it/s]
0it [00:00, ?it/s]  6%|▋         | 106496/1648877 [00:00<00:01, 1001063.64it/s]1654784it [00:00, 12539257.56it/s]                           
0it [00:00, ?it/s]8192it [00:00, 242109.80it/s]Downloading http://yann.lecun.com/exdb/mnist/train-images-idx3-ubyte.gz to mlmodels/dataset/vision/MNIST/MNIST/raw/train-images-idx3-ubyte.gz
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f438591ae80>, <torch.utils.data.dataloader.DataLoader object at 0x7f438551cd30>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f4385513f28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f4385513f28>

  function with postional parmater data_info <function get_dataset_torch at 0x7f4385513f28> , (data_info, **args) 
...
transform torchvision_dataset_MNIST_load() missing 1 required positional argument: 'path'
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f4384aff6d8>, <torch.utils.data.dataloader.DataLoader object at 0x7f4384aff748>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f439b44e268>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f439b44e268>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f43eea81ae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f43eea81ae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f439b44ea60>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f439b44ea60>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7f4384aff208> 
