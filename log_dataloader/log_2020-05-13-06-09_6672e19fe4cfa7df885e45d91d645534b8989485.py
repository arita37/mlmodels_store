 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/6672e19fe4cfa7df885e45d91d645534b8989485', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/dev/', 'repo': 'arita37/mlmodels', 'branch': 'dev', 'sha': '6672e19fe4cfa7df885e45d91d645534b8989485', 'workflow': 'test_dataloader'}
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fe6bb802378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fe6bb802378>

  function with postional parmater data_info <function get_dataset_torch at 0x7fe6bb802378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s]  1%|          | 98304/9912422 [00:00<00:11, 865640.86it/s] 12%|█▏        | 1146880/9912422 [00:00<00:07, 1192843.37it/s] 88%|████████▊ | 8708096/9912422 [00:00<00:00, 1692417.44it/s]9920512it [00:00, 18440966.31it/s]                            
0it [00:00, ?it/s]  0%|          | 0/28881 [00:00<?, ?it/s]32768it [00:00, 211507.67it/s]           
0it [00:00, ?it/s]  0%|          | 0/1648877 [00:00<?, ?it/s]  6%|▌         | 98304/1648877 [00:00<00:01, 944028.82it/s]1654784it [00:00, 4976291.15it/s]                          
0it [00:00, ?it/s]  0%|          | 0/4542 [00:00<?, ?it/s]8192it [00:00, 71867.41it/s]            dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fe6ba3340f0>, <torch.utils.data.dataloader.DataLoader object at 0x7fe6ba3516d8>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fe6b9b54400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fe6b9b54400>

  function with postional parmater data_info <function get_dataset_torch at 0x7fe6b9b54400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fe6b9b62a90>, <torch.utils.data.dataloader.DataLoader object at 0x7fe6b9b62b00>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fe6b9b67b70>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fe6b9b67b70>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fe70df85e18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fe70df85e18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fe6b9b54488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fe6b9b54488>
