 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/9de16dc520bec0018dfef93b55cc07255f7541f0', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '9de16dc520bec0018dfef93b55cc07255f7541f0', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/9de16dc520bec0018dfef93b55cc07255f7541f0

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/9de16dc520bec0018dfef93b55cc07255f7541f0
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fa8de099f28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fa8de099f28>

  function with postional parmater data_info <function get_dataset_torch at 0x7fa8de099f28> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
Using TensorFlow backend.
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 40%|███▉      | 3956736/9912422 [00:00<00:00, 39554289.36it/s]9920512it [00:00, 27219916.15it/s]                             
0it [00:00, ?it/s]32768it [00:00, 590609.45it/s]
0it [00:00, ?it/s]  1%|          | 16384/1648877 [00:00<00:11, 147534.44it/s]1654784it [00:00, 10693034.87it/s]                         
0it [00:00, ?it/s]8192it [00:00, 181819.68it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fa8c72a6fd0>, <torch.utils.data.dataloader.DataLoader object at 0x7fa8c72b2c50>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fa8c72d11e0>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fa8c72d11e0>

  function with postional parmater data_info <function get_dataset_torch at 0x7fa8c72d11e0> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fa8c6896d68>, <torch.utils.data.dataloader.DataLoader object at 0x7fa8c6896dd8>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fa8de0a2a60>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fa8de0a2a60>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fa93081dae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fa93081dae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fa8c7f1f400>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fa8c7f1f400>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7fa8de097eb8> 
