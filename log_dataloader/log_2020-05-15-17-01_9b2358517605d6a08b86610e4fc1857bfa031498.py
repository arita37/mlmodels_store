 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/9b2358517605d6a08b86610e4fc1857bfa031498', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '9b2358517605d6a08b86610e4fc1857bfa031498', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/9b2358517605d6a08b86610e4fc1857bfa031498

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/9b2358517605d6a08b86610e4fc1857bfa031498
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fa1c0204ea0>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fa1c0204ea0>

  function with postional parmater data_info <function get_dataset_torch at 0x7fa1c0204ea0> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
Using TensorFlow backend.
0it [00:00, ?it/s]  0%|          | 16384/9912422 [00:00<01:05, 151804.52it/s] 79%|███████▊  | 7782400/9912422 [00:00<00:09, 216679.91it/s]9920512it [00:00, 42751229.24it/s]                           
0it [00:00, ?it/s]32768it [00:00, 588999.68it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 471981.99it/s]1654784it [00:00, 11827873.52it/s]                         
0it [00:00, ?it/s]8192it [00:00, 205120.52it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fa1a9414f28>, <torch.utils.data.dataloader.DataLoader object at 0x7fa1a941eb00>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fa1a943d158>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fa1a943d158>

  function with postional parmater data_info <function get_dataset_torch at 0x7fa1a943d158> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fa1a8a01cc0>, <torch.utils.data.dataloader.DataLoader object at 0x7fa1a8a01d30>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fa1c0208e18>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fa1c0208e18>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fa212987ae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fa212987ae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fa1aa08a7b8>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fa1aa08a7b8>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7fa1a83315f8> 
