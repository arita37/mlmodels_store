 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/9a6fd65adf5db1dcad55c1f3eba8df110a2b1a2a', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '9a6fd65adf5db1dcad55c1f3eba8df110a2b1a2a', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/9a6fd65adf5db1dcad55c1f3eba8df110a2b1a2a

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/9a6fd65adf5db1dcad55c1f3eba8df110a2b1a2a
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fd855becf28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fd855becf28>

  function with postional parmater data_info <function get_dataset_torch at 0x7fd855becf28> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 28%|██▊       | 2744320/9912422 [00:00<00:00, 24105027.81it/s]9920512it [00:00, 36621018.20it/s]                             
0it [00:00, ?it/s]32768it [00:00, 369874.17it/s]
0it [00:00, ?it/s]  1%|          | 16384/1648877 [00:00<00:09, 163810.47it/s]1654784it [00:00, 10971218.57it/s]                         
0it [00:00, ?it/s]8192it [00:00, 203679.65it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fd854720128>, <torch.utils.data.dataloader.DataLoader object at 0x7fd85473c940>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fd854736f28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fd854736f28>

  function with postional parmater data_info <function get_dataset_torch at 0x7fd854736f28> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fd854151ac8>, <torch.utils.data.dataloader.DataLoader object at 0x7fd854151b38>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fd85415e7b8>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fd85415e7b8>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fd8a8370ae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fd8a8370ae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fd854148488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fd854148488>
