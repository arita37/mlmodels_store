...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fca723bc378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fca723bc378>

  function with postional parmater data_info <function get_dataset_torch at 0x7fca723bc378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 0/9912422 [00:00<?, ?it/s] 41%|████▏     | 4096000/9912422 [00:00<00:00, 39409425.72it/s]9920512it [00:00, 34535753.79it/s]                             
0it [00:00, ?it/s]32768it [00:00, 703149.22it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 470144.65it/s]1654784it [00:00, 12066927.02it/s]                         
0it [00:00, ?it/s]8192it [00:00, 203937.15it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fca71346080>, <torch.utils.data.dataloader.DataLoader object at 0x7fca706f97b8>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fca7070c400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fca7070c400>

  function with postional parmater data_info <function get_dataset_torch at 0x7fca7070c400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fca7071aa20>, <torch.utils.data.dataloader.DataLoader object at 0x7fca7071aa90>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fca71343d90>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fca71343d90>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fcac4b3de18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fcac4b3de18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fca7071ea60>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fca7071ea60>
