...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f8481353378>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f8481353378>

  function with postional parmater data_info <function get_dataset_torch at 0x7f8481353378> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
0it [00:00, ?it/s]  0%|          | 49152/9912422 [00:00<00:20, 475977.96it/s] 75%|███████▌  | 7438336/9912422 [00:00<00:03, 678093.62it/s]9920512it [00:00, 46135999.99it/s]                           
0it [00:00, ?it/s]32768it [00:00, 724064.11it/s]
0it [00:00, ?it/s]  1%|          | 16384/1648877 [00:00<00:11, 148378.93it/s]1654784it [00:00, 10799182.75it/s]                         
0it [00:00, ?it/s]  0%|          | 0/4542 [00:00<?, ?it/s]8192it [00:00, 37691.48it/s]            dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f847fe850f0>, <torch.utils.data.dataloader.DataLoader object at 0x7f847f6907f0>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7f847f6a5400>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7f847f6a5400>

  function with postional parmater data_info <function get_dataset_torch at 0x7f847f6a5400> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7f847f6b3a90>, <torch.utils.data.dataloader.DataLoader object at 0x7f847f6b3b00>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7f847f6b8b70>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7f847f6b8b70>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7f84d3ad7e18>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7f84d3ad7e18>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

Using TensorFlow backend.

###### load_callable_from_uri LOADED <function pickle_dump at 0x7f847f6a5488>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7f847f6a5488>
