 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/337f4c30c2e27961a5c4460c67365af28cc9cfed', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'adata2', 'sha': '337f4c30c2e27961a5c4460c67365af28cc9cfed', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_BRANCH : https://github.com/arita37/mlmodels/tree/adata2/

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/337f4c30c2e27961a5c4460c67365af28cc9cfed

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/337f4c30c2e27961a5c4460c67365af28cc9cfed
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fbdd7ecbf28>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fbdd7ecbf28>

  function with postional parmater data_info <function get_dataset_torch at 0x7fbdd7ecbf28> , (data_info, **args) 

  #### If transformer URI is Provided 

  #### Loading dataloader URI 
Using TensorFlow backend.
0it [00:00, ?it/s]  0%|          | 16384/9912422 [00:00<01:10, 141338.77it/s] 60%|██████    | 5971968/9912422 [00:00<00:19, 201707.34it/s]9920512it [00:00, 39443747.54it/s]                           
0it [00:00, ?it/s]32768it [00:00, 621010.57it/s]
0it [00:00, ?it/s]  3%|▎         | 49152/1648877 [00:00<00:03, 478095.10it/s]1654784it [00:00, 11688639.11it/s]                         
0it [00:00, ?it/s]8192it [00:00, 204235.35it/s]dataset :  <class 'torchvision.datasets.mnist.MNIST'>
...
Done!
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fbdc10d8fd0>, <torch.utils.data.dataloader.DataLoader object at 0x7fbdc10e4c50>), {})
...
###### load_callable_from_uri LOADED <function get_dataset_torch at 0x7fbdc11031e0>

 ######### postional parameteres :  ['data_info']

 ######### Execute : preprocessor_func <function get_dataset_torch at 0x7fbdc11031e0>

  function with postional parmater data_info <function get_dataset_torch at 0x7fbdc11031e0> , (data_info, **args) 
...
dataset :  <class 'torchvision.datasets.mnist.MNIST'>
 ...
 #####  get_Data DataLoader 
((<torch.utils.data.dataloader.DataLoader object at 0x7fbdc06c8d68>, <torch.utils.data.dataloader.DataLoader object at 0x7fbdc06c8dd8>), {})
...
###### load_callable_from_uri LOADED <function split_xy_from_dict at 0x7fbdd7ed4a60>

 ######### postional parameteres :  ['out']

 ######### Execute : preprocessor_func <function split_xy_from_dict at 0x7fbdd7ed4a60>

  URL:  sklearn.model_selection::train_test_split {'test_size': 0.5} 

###### load_callable_from_uri LOADED <function train_test_split at 0x7fbe2a64fae8>

 ######### postional parameteres :  []

 ######### Execute : preprocessor_func <function train_test_split at 0x7fbe2a64fae8>

  URL:  mlmodels/dataloader.py::pickle_dump {'path': 'mlmodels/ztest/ml_keras/namentity_crm_bilstm/data.pkl'} 

###### load_callable_from_uri LOADED <function pickle_dump at 0x7fbdc1d51400>

 ######### postional parameteres :  ['t']

 ######### Execute : preprocessor_func <function pickle_dump at 0x7fbdc1d51400>
...
###### Test_run_model  #############################################################
 ...
 ######### {'model_uri': 'model_tch.torchhub', 'pars': {'choice': 'json', 'config_mode': 'test', 'data_path': 'dataset/json/refactor/torchhub_cnn_dataloader.json'}}
  ...
  <mlmodels.model_tch.torchhub.Model object at 0x7fbe279095f8> 

  #### Fit   ######################################################## 

Traceback (most recent call last):
  File "/home/runner/work/mlmodels/mlmodels/mlmodels/dataloader.py", line 472, in test_dataloader
...
Traceback (most recent call last):
  File "/home/runner/work/mlmodels/mlmodels/mlmodels/dataloader.py", line 484, in test_dataloader
    loader.compute()
