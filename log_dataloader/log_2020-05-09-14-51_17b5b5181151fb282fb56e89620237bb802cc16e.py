 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/17b5b5181151fb282fb56e89620237bb802cc16e', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/refs/heads/adata2/', 'repo': 'arita37/mlmodels', 'branch': 'refs/heads/adata2', 'sha': '17b5b5181151fb282fb56e89620237bb802cc16e', 'workflow': 'test_dataloader'}

 ******** GITHUB_WOKFLOW : https://github.com/arita37/mlmodels/actions?query=workflow%3Atest_dataloader

 ******** GITHUB_REPO_URL : https://github.com/arita37/mlmodels/tree/17b5b5181151fb282fb56e89620237bb802cc16e

 ******** GITHUB_COMMIT_URL : https://github.com/arita37/mlmodels/commit/17b5b5181151fb282fb56e89620237bb802cc16e
...
0it [00:00, ?it/s]  0%|          | 16384/9912422 [00:00<01:08, 145178.72it/s] 38%|███▊      | 3768320/9912422 [00:00<00:29, 207051.19it/s] 95%|█████████▍| 9396224/9912422 [00:00<00:01, 295315.11it/s]9920512it [00:00, 30714139.89it/s]                           
0it [00:00, ?it/s]32768it [00:00, 493114.69it/s]
0it [00:00, ?it/s]  1%|          | 16384/1648877 [00:00<00:10, 154401.50it/s]1654784it [00:00, 10457001.07it/s]                         
0it [00:00, ?it/s]8192it [00:00, 218918.77it/s]['resnet34_benchmark_mnist.json', 'keras_reuters_charcnn.json', 'keras_textcnn.json', 'namentity_crm_bilstm_new.json', 'armdn_dataloader.json', 'matchzoo_models_new.json', 'resnet18_benchmark_mnist.json', 'torchhub_cnn_dataloader.json']
...
{'data_info': {'data_path': 'mlmodels/dataset/vision/MNIST', 'dataset': 'MNIST', 'data_type': 'tch_dataset', 'batch_size': 10, 'train': True}, 'preprocessors': [{'name': 'tch_dataset_start', 'uri': 'mlmodels/preprocess/generic.py::get_dataset_torch', 'args': {'dataloader': 'torchvision.datasets:MNIST', 'to_image': True, 'transform': {'uri': 'mlmodels.preprocess.image:torchvision_dataset_MNIST_load', 'pass_data_pars': False, 'arg': {'fixed_size': 256}}, 'shuffle': True, 'download': True}}]}
 ...
 #####  compute DataLoader 
Mismatch input / output data type {'name': 'tch_dataset_start', 'uri': 'mlmodels/preprocess/generic.py::get_dataset_torch', 'args': {'dataloader': 'torchvision.datasets:MNIST', 'to_image': True, 'transform': {'uri': 'mlmodels.preprocess.image:torchvision_dataset_MNIST_load', 'pass_data_pars': False, 'arg': {'fixed_size': 256}}, 'shuffle': True, 'download': True}} 
...
Processing...
Done!
((<torch.utils.data.dataloader.DataLoader object at 0x7f4dd416be80>, <torch.utils.data.dataloader.DataLoader object at 0x7f4dd24a8828>), {})
...
torchvision_dataset_MNIST_load() missing 1 required positional argument: 'path'
dset :  <class 'torchvision.datasets.mnist.MNIST'>
((<torch.utils.data.dataloader.DataLoader object at 0x7f4dd24c4978>, <torch.utils.data.dataloader.DataLoader object at 0x7f4dd24c49e8>), {})
...
{'data_info': {'dataset': 'mlmodels/dataset/text/imdb', 'pass_data_pars': False, 'train': True, 'maxlen': 40, 'max_features': 5}, 'preprocessors': [{'name': 'loader', 'uri': 'mlmodels/preprocess/generic.py::NumpyDataset', 'args': {'numpy_loader_args': {'allow_pickle': True}, 'encoding': "'ISO-8859-1'"}}]}
 ...
 #####  compute DataLoader 
Mismatch input / output data type {'name': 'loader', 'uri': 'mlmodels/preprocess/generic.py::NumpyDataset', 'args': {'numpy_loader_args': {'allow_pickle': True}, 'encoding': "'ISO-8859-1'"}} 
...
URL:  mlmodels/dataloader.py::pickle_dump {'path': 'ztest/ml_keras/namentity_crm_bilstm/data.pkl'}
postional parameteres :  ['t']
Error /home/runner/work/mlmodels/mlmodels/mlmodels/dataset/json/refactor/namentity_crm_bilstm_new.json [Errno 2] No such file or directory: 'ztest/ml_keras/namentity_crm_bilstm/data.pkl'
