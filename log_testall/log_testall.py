...
log_testall
test_jupyter
[master 545b286] ml_store  && git pull --all
 1 file changed, 44 insertions(+)
To github.com:arita37/mlmodels_store.git
 + e55660f...545b286 master -> master (forced update)
...
Building wheels for collected packages: en-core-web-sm
  ...
  Created wheel for en-core-web-sm: filename=en_core_web_sm-2.2.5-py3-none-any.whl size=12011738 sha256=b3aaa4c1ff97cfe790db2b45743a1ab2fb7396ec16b6d33fac3cd1aa7cc37903
  Stored in directory: /tmp/pip-ephem-wheel-cache-w6wcejyd/wheels/b5/94/56/596daa677d7e91038cbddfcf32b591d0c915a1b3a3e3d3c79d
...
log_testall
test_jupyter
[master 73526cf] ml_store  && git pull --all
 2 files changed, 106 insertions(+)
To github.com:arita37/mlmodels_store.git
 + b09c671...73526cf master -> master (forced update)
...
log_testall
test_jupyter
[master eb9dadc] ml_store  && git pull --all
 1 file changed, 30 insertions(+)
To github.com:arita37/mlmodels_store.git
   73526cf..eb9dadc  master -> master
