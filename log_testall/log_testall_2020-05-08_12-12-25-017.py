...
From github.com:arita37/mlmodels_store
   bd44ea3..ebbab84  master     -> origin/master
Updating bd44ea3..ebbab84
Fast-forward
 log_pullrequest/log_2020-05-08_12-09-54-336.py | 21 +++++++++++++++++++++
 1 file changed, 21 insertions(+)
 create mode 100644 log_pullrequest/log_2020-05-08_12-09-54-336.py
Logs
README.md
README_actions.md
...
log_testall
test_jupyter
[master d9edf8c] ml_store
 1 file changed, 42 insertions(+)
 create mode 100644 log_testall/log_testall_2020-05-08_12-12-25-017.py
To github.com:arita37/mlmodels_store.git
   ebbab84..d9edf8c  master -> master
...
9  0.000000  0.173783  0.369041  0.411721  0.411721  0.304384
  ('#### metrics   #####################################################',) 
{'loss': 0.4582262746989727, 'loss_history': []}
  ('#### Plot   ########################################################',) 
  ('#### Save/Load   ###################################################',) 
...
log_testall
test_jupyter
[master 8846c31] ml_store
 1 file changed, 94 insertions(+)
To github.com:arita37/mlmodels_store.git
   d9edf8c..8846c31  master -> master
...
{'path': '/home/runner/work/mlmodels/mlmodels/mlmodels/ztest/model_sklearn/model_lightgbm/model.pkl'}
<__main__.Model object at 0x7fe079e3ee80>
  ('#### Module init   ############################################',) 
  (<module 'mlmodels.model_sklearn.model_lightgbm' from '/home/runner/work/mlmodels/mlmodels/mlmodels/model_sklearn/model_lightgbm.py'>,) 
  ('#### Loading params   ##############################################',) 
  ('#### Path params   ##########################################',) 
  ('#### Model init   ############################################',) 
  (<mlmodels.model_sklearn.model_lightgbm.Model object at 0x7fe079e3eef0>,) 
  ('#### Fit   ########################################################',) 
  ('#### Predict   ####################################################',) 
...
log_testall
test_jupyter
[master 7d3cd0e] ml_store
 1 file changed, 240 insertions(+)
To github.com:arita37/mlmodels_store.git
   8846c31..7d3cd0e  master -> master
...
{'roc_auc_score': 0.9583333333333333}
  ...
  ('#### Path params   ##########################################',) 
  ('#### Model init   ############################################',) 
  (<mlmodels.model_sklearn.model_sklearn.Model object at 0x7f14a190b630>,) 
  ('#### Fit   ########################################################',) 
  ('#### Predict   ####################################################',) 
None
  ('#### Get  metrics   ################################################',) 
...
log_testall
test_jupyter
[master 09d6281] ml_store
 1 file changed, 77 insertions(+)
To github.com:arita37/mlmodels_store.git
   7d3cd0e..09d6281  master -> master
