 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/cda74d00ddd7567d2de9bfc8ff05b7b6ca649e4b', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/dev/', 'repo': 'arita37/mlmodels', 'branch': 'dev', 'sha': 'cda74d00ddd7567d2de9bfc8ff05b7b6ca649e4b', 'workflow': 'test_pullrequest'}
 ...
 ********************************************************************************************************************************************
  ...
  test_import 
['model_sklearn.__init__', 'model_keras.armdn', 'model_keras.__init__', 'model_keras.namentity_crm_bilstm', 'model_keras.textcnn', 'model_keras.util', 'model_keras.charcnn', 'model_keras.charcnn_zhang', 'model_keras.Autokeras', 'model_keras.preprocess', 'model_keras.deepctr', 'model_tch.matchZoo', 'model_tch.util_data', 'model_tch.__init__', 'model_tch.textcnn', 'model_tch.transformer_sentence', 'model_tch.util_transformer', 'model_tch.torchhub', 'model_gluon.gluonts_model', 'model_gluon.__init__', 'model_gluon.gluonts_model_old', 'model_gluon.gluon_automl', 'model_gluon.util_autogluon', 'model_gluon.util', 'model_gluon.fb_prophet', 'model_dev.__init__', 'model_dev.temporal_fusion_google', 'template.00_template_keras', 'template.model_xxx', 'preprocess.tabular', 'preprocess.tabular_keras', 'preprocess.image', 'preprocess.ztemp', 'preprocess.__init__', 'preprocess.timeseries', 'preprocess.text', 'preprocess.generic', 'preprocess.text_keras', 'preprocess.text_torch', 'preprocess.generic_old', 'example.vision_mnist', 'example.lightgbm_glass', 'example.arun_model', 'example.arun_hyper', 'example.benchmark_timeseries_m4', 'example.benchmark_timeseries_m5', 'utils.ztest_structure', 'utils.test_dataloader', 'utils.parse', 'model_tf.1_lstm', 'model_tf.__init__', 'model_tf.util', 'model_rank.__init__']
...
future: <Task finished coro=<InProcConnector.connect() done, defined at /opt/hostedtoolcache/Python/3.6.12/x64/lib/python3.6/site-packages/distributed/comm/inproc.py:285> exception=OSError("no endpoint for inproc address '10.1.0.4/3376/1'",)>
Traceback (most recent call last):
...
OSError: no endpoint for inproc address '10.1.0.4/3376/1'
