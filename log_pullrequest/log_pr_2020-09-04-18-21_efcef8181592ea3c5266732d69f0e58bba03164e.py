 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/efcef8181592ea3c5266732d69f0e58bba03164e', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/dev/', 'repo': 'arita37/mlmodels', 'branch': 'dev', 'sha': 'efcef8181592ea3c5266732d69f0e58bba03164e', 'workflow': 'test_pullrequest'}
...
[W 2020-09-04 18:22:10,182] Setting status of trial#0 as TrialState.FAIL because of the following error: UnboundLocalError("local variable 'module' referenced before assignment",)
...
Deprecaton set to False
  ...
  ###### Hyper-optimization through study   ################################## 
[W 2020-09-04 18:22:14,130] Setting status of trial#0 as TrialState.FAIL because of the following error: UnboundLocalError("local variable 'module' referenced before assignment",)
Traceback (most recent call last):
  File "/opt/hostedtoolcache/Python/3.6.12/x64/lib/python3.6/site-packages/optuna/study.py", line 569, in _run_trial
    result = func(trial)
  File "/home/runner/work/mlmodels/mlmodels/mlmodels/optim.py", line 143, in objective
...
Exception: ('Unknown dataset type', '[W 2020-09-04 18:22:14,130] Setting status of trial#0 as TrialState.FAIL because of the following error: UnboundLocalError("local variable \'module\' referenced before assignment",)\n')
