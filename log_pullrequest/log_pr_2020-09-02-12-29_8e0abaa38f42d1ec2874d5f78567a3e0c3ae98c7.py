...
[W 2020-09-02 12:29:44,610] Setting status of trial#0 as TrialState.FAIL because of the following error: UnboundLocalError("local variable 'module' referenced before assignment",)
...
Deprecaton set to False
  ...
  ###### Hyper-optimization through study   ################################## 
[W 2020-09-02 12:29:48,485] Setting status of trial#0 as TrialState.FAIL because of the following error: UnboundLocalError("local variable 'module' referenced before assignment",)
Traceback (most recent call last):
  File "/opt/hostedtoolcache/Python/3.6.12/x64/lib/python3.6/site-packages/optuna/study.py", line 569, in _run_trial
    result = func(trial)
  File "/home/runner/work/mlmodels/mlmodels/mlmodels/optim.py", line 143, in objective
...
Exception: ('Unknown dataset type', '[W 2020-09-02 12:29:48,485] Setting status of trial#0 as TrialState.FAIL because of the following error: UnboundLocalError("local variable \'module\' referenced before assignment",)\n')
