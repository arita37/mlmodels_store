 ...
 ******** TAG ::  {'github_repo_url': 'https://github.com/arita37/mlmodels/tree/4cdc002cba85d4437aab96db0de9f52c658a62a5', 'url_branch_file': 'https://github.com/arita37/mlmodels/blob/dev/', 'repo': 'arita37/mlmodels', 'branch': 'dev', 'sha': '4cdc002cba85d4437aab96db0de9f52c658a62a5', 'workflow': 'test_pullrequest'}
 ...
 ********************************************************************************************************************************************
  ...
  test_import 
['model_keras.namentity_crm_bilstm', 'model_keras.armdn', 'model_keras.Autokeras', 'model_keras.charcnn', 'model_keras.__init__', 'model_keras.deepctr', 'model_keras.preprocess', 'model_keras.util', 'model_keras.charcnn_zhang', 'model_keras.textcnn', 'example.arun_hyper', 'example.lightgbm_glass', 'example.benchmark_timeseries_m4', 'example.vision_mnist', 'example.arun_model', 'example.benchmark_timeseries_m5', 'template.model_xxx', 'template.00_template_keras', 'model_sklearn.__init__', 'model_gluon.fb_prophet', 'model_gluon.gluon_automl', 'model_gluon.__init__', 'model_gluon.gluonts_model_old', 'model_gluon.util_autogluon', 'model_gluon.util', 'model_gluon.gluonts_model', 'utils.test_dataloader', 'utils.ztest_structure', 'utils.model_v1', 'utils.predict', 'utils.train', 'utils.parse', 'utils.bayesian', 'preprocess.image', 'preprocess.generic', 'preprocess.__init__', 'preprocess.generic_old', 'preprocess.timeseries', 'preprocess.tabular_keras', 'preprocess.text_torch', 'preprocess.text_keras', 'preprocess.text', 'preprocess.ztemp', 'preprocess.tabular', 'model_dev.temporal_fusion_google', 'model_dev.__init__', 'model_rank.__init__', 'model_tch.torchhub', 'model_tch.matchZoo', 'model_tch.__init__', 'model_tch.util_transformer', 'model_tch.transformer_sentence', 'model_tch.util_data', 'model_tch.textcnn', 'model_tf.__init__', 'model_tf.util', 'model_tf.1_lstm']

  Error mlmodels.model_keras.namentity_crm_bilstm unindent does not match any outer indentation level (dataloader.py, line 318) 
...
mlmodels.model_keras.__init__
  ...
  Error mlmodels.model_keras.deepctr cannot import name 'DenseFeat' 

  Error mlmodels.model_keras.preprocess cannot import name 'DenseFeat' 
mlmodels.model_keras.util
/home/runner/work/mlmodels/mlmodels/mlmodels/dataset
mlmodels.model_keras.charcnn_zhang

  Error mlmodels.model_keras.textcnn unindent does not match any outer indentation level (dataloader.py, line 318) 

  Error mlmodels.example.arun_hyper name 'copy' is not defined 

  Error mlmodels.example.lightgbm_glass unindent does not match any outer indentation level (models.py, line 92) 
mlmodels.example.benchmark_timeseries_m4

  Error mlmodels.example.vision_mnist invalid syntax (vision_mnist.py, line 15) 

  Error mlmodels.example.arun_model unindent does not match any outer indentation level (models.py, line 92) 
...
/opt/hostedtoolcache/Python/3.6.12/x64/lib/python3.6/site-packages/mxnet/optimizer/optimizer.py:167: UserWarning:
...
mlmodels.model_gluon.util
  ...
  Error mlmodels.utils.test_dataloader unindent does not match any outer indentation level (dataloader.py, line 318) 
mlmodels.utils.ztest_structure
mlmodels.utils.model_v1

  Error mlmodels.utils.predict No module named 'offline' 

  Error mlmodels.utils.train No module named 'offline' 
mlmodels.utils.parse

  Error mlmodels.utils.bayesian invalid syntax (bayesian.py, line 650) 
...
mlmodels.preprocess.timeseries
  ...
  Error mlmodels.preprocess.tabular_keras cannot import name 'SparseFeat' 
...
/home/runner/work/mlmodels/mlmodels/mlmodels/utils/model_v1.py:973: DeprecationWarning:

invalid escape sequence \*

/home/runner/work/mlmodels/mlmodels/mlmodels/preprocess/generic.py:740: DeprecationWarning:

invalid escape sequence \(

/home/runner/work/mlmodels/mlmodels/mlmodels/preprocess/generic.py:741: DeprecationWarning:

invalid escape sequence \)

/home/runner/work/mlmodels/mlmodels/mlmodels/preprocess/generic.py:742: DeprecationWarning:
...
WARNING:tensorflow:From /opt/hostedtoolcache/Python/3.6.12/x64/lib/python3.6/site-packages/tensorflow_core/python/compat/v2_compat.py:68: disable_resource_variables (from tensorflow.python.ops.variable_scope) is deprecated and will be removed in a future version.
...
Exception: ('Unknown dataset type', 'IndentationError: unindent does not match any outer indentation level\n')
Task exception was never retrieved
future: <Task finished coro=<InProcConnector.connect() done, defined at /opt/hostedtoolcache/Python/3.6.12/x64/lib/python3.6/site-packages/distributed/comm/inproc.py:285> exception=OSError("no endpoint for inproc address '10.1.0.4/3207/1'",)>
Traceback (most recent call last):
...
OSError: no endpoint for inproc address '10.1.0.4/3207/1'
